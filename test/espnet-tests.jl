...
@test size(yhat.encoder.enc1) == (128,128,19,1) || @error "encoder.enc1 error"
@test size(yhat.encoder.enc2) == (64,64,131,1)  || @error "encoder.enc2 error"
@test size(yhat.encoder.enc3) == (32,32,256,1)  || @error "encoder.enc3 error"
