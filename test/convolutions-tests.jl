...
@test size(TinyMachines.ConvTranspK2(1, 1)(x1)) == (256,256,1,1)
@test size(TinyMachines.ConvTranspK2(3, 1)(x3)) == (256,256,1,1)
@test size(TinyMachines.ConvTranspK2(1, 1; stride=2)(x1)) == (512,512,1,1)
@test size(TinyMachines.ConvTranspK2(3, 1; stride=2)(x3)) == (512,512,1,1)
