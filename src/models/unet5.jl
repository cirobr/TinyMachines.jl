...
function (m::UNet5)(x)
    ...
    dec5 = m.dec[1](enc5)
    dec4 = m.dec[2](cat(enc4, dec5; dims=3))
    dec3 = m.dec[3](cat(enc3, dec4; dims=3))
    dec2 = m.dec[4](cat(enc2, dec3; dims=3))
    dec1 = m.dec[5](cat(enc1, dec2; dims=3))
