...
function UNet5(ch_in::Int=3, ch_out::Int=1;   # input/output channels
    ...
    c5 = Chain(MaxPoolK2,
               ConvK3(chs[4], chs[5]), BatchNorm(chs[5], activation),
               Dropout(0.3),
    ...
    e4 = Chain(ConvK3(chs[5], chs[4]), BatchNorm(chs[4], activation),
               Dropout(0.25),
               ConvK3(chs[4], chs[4]), BatchNorm(chs[4], activation),
...
function (m::UNet5)(x)
    ...
    dec5 = m.dec[:e5](enc5)
    dec4 = m.dec[:e4](cat(enc4, dec5; dims=3))
